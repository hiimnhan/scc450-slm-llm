...
#==================================================
# accessing json file in subfolders + tokenization
#==================================================
...
def json_paths(subfolder_paths, output_subfolder_pathing):
    ...
    for subfolder, output_path in zip(subfolder_json_file_names, output_subfolder_pathing):
        # print(f'\nthis is a subfolder:\n {subfolder}\n')
        for file in subfolder:
            print(f'\nthis is a file in a subfolder:\n {file}')
            print(f' this file is allocated to path: {output_path}')
    ...
    return subfolder_json_file_names #, subfolder_json_pathing

json_file_names = json_paths(subfolder_paths_list, output_subfolder_paths)

print(f'\n new json names are: {json_file_names}') # name checking
# print(f'\n new json paths are: {json_file_paths}') # path checking  , json_file_paths
